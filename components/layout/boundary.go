...
func AppShellWithBoundary(appName string) templ.Component {
	return devmode.ComponentBoundary("AppShell", map[string]any{"appName": appName}, AppShell(appName))
}
...
func SidebarWithBoundary(appName string, groups []SidebarGroup) templ.Component {
	return devmode.ComponentBoundary("Sidebar", map[string]any{
		"appName":    appName,
...
func NavbarWithBoundary(appName string) templ.Component {
	return devmode.ComponentBoundary("Navbar", map[string]any{"appName": appName}, Navbar(appName))
}
